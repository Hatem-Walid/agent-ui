      ...
      <div className="relative w-[800px] h-[600px] bg-[#0D0C1E] rounded-[10px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-10 group border border-gray-800">
        ...
        <header className="flex justify-between items-center p-[30px] relative z-20">
          <div className="w-[18px] h-[18px] cursor-pointer relative group">
            <div className="absolute top-0 left-0 w-full h-0.5 bg-white/70 rounded-xs shadow-[0_5px_0_rgba(255,255,255,0.7),0_10px_0_rgba(255,255,255,0.7)] group-hover:bg-white transition-colors"></div>
          </div>
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 top-[30px] text-center">
            ...
            <svg viewBox="0 0 61 14" className="w-[61px] h-3.5 opacity-80">
        ...
        <div className="text-center pt-[90px]  text-white relative z-20 ">
          <h1 className="font-black text-[165px] leading-none -mb-2.5 opacity-90 drop-shadow-2xl">404</h1>
          <h2 className="font-bold text-[34px] mb-1.5 opacity-100 drop-shadow-lg">Page not found</h2>
          ...
          <a className="inline-block font-bold text-[12px] uppercase border-2 border-white px-[18px] py-2.5 rounded-sm hover:bg-white hover:text-black transition-all cursor-pointer tracking-wider backdrop-blur-sm">
            Back to Home
          </a>
        </div>
